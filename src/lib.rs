...
pub mod game;
pub mod piece;
// Bring in ggez dependencies for the implementation
use crate::board::CellState;
use crate::game::Game;
use crate::piece::{get_blocks, get_color};
use crate::piece::{Direction, GamePiece};
use ggez::input::keyboard::KeyInput;
use ggez::input::keyboard::*;
use ggez::{graphics::Canvas, graphics::DrawParam};
...
impl ggez::event::EventHandler for Game {
    ...
    fn draw(&mut self, ctx: &mut Context) -> GameResult {
            ...
            for x in 0..10 {
                ...
                let color = if is_block {
                    ...
                    match self.board[y as usize][x as usize] {
                        CellState::Occupied { r, g, b } => Color::from_rgba(r, g, b, 128),
        ...
        canvas.draw(
            &score_text,
            DrawParam::default().dest([440.0, 20.0]).color(Color::WHITE),
        );
